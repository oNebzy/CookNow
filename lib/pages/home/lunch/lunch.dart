...
class Lunch extends StatefulWidget {
  ...
  @override
  _LunchState createState() => _LunchState(id);
}
...
class _LunchState extends State<Lunch> {
  ...
  Future<void> getData() async{
    print('$id');
    await curr.collection('users').doc('$id').collection('lunch').get().then((querySnapshot) {
  ...
  Widget build(BuildContext context) {
              ...
              children: [
                ...
                TextButton.icon(
                    ...
                    onPressed: () async {
                      ...
                      DatabaseService(widget.id!).addUserData('lunch', name, ingred, instrucs);
    ...
    return StreamProvider<List<Recipe>?>.value(
      initialData: null,
      value: DatabaseService(widget.id!).lunch,
      child: Scaffold(
        backgroundColor: Colors.blue[700],
        appBar: AppBar(
          backgroundColor: Colors.blue[900],
          title: Text('Lunch Recipe List'),
          centerTitle: false,
          elevation: 1,
          actions: [
            Padding(
